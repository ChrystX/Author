...
public class AuthorsService
{
    ...
    public async Task CreateAsync(Author newAuth) =>
        await _authorsCollection.InsertOneAsync(newAuth);

    public async Task UpdateAsync(string id, Author updatedAuth) =>
        await _authorsCollection.ReplaceOneAsync(x => x.Id == id, updatedAuth);
